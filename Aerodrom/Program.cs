namespace Aerodrom
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Flights.Trips.Add(0, new Flight("Pariz", DateTime.Parse("5.5.2026. 12:00"), DateTime.Parse("5.5.2026. 14:00"), 457, 2, 0));
            Flights.Trips.Add(1, new Flight("Chicago", DateTime.Parse("21.12.2025. 20:00"), DateTime.Parse("22.12.2025. 13:00"), 1102, 17, 1));
            Flights.Trips.Add(2, new Flight("Peking", DateTime.Parse("5.2.2026. 8:00"), DateTime.Parse("6.2.2026. 6:00"), 1365, 22, 2));
            ...
            Planes.Airplanes.Add(0, new Plane("a320", 2010, new List<int>{0}, seats));
            seats = new List<Tuple<string, int>>() { Tuple.Create("economy", 300), Tuple.Create("business", 50) };
            Planes.Airplanes.Add(1, new Plane("a350", 2005, new List<int> {1}, seats));
            seats = new List<Tuple<string, int>>() { Tuple.Create("economy", 400), Tuple.Create("business", 120) };
            Planes.Airplanes.Add(2, new Plane("a380", 2012, new List<int>{2}, seats));
            ...
            while (inApp)
            {
                ...
                switch (menuInput)
                {
                    case 1: passengers.PassengersMenu(); break;
                    case 2: flights.FlightsMenu(); break;
                    case 3: planes.PlanesMenu(); break;
                    case 4: crew.CrewMenu(); break;
                    case 0:
